...
*Foco em configurar a comunicação com o backend e garantir o acesso seguro do usuário.*

- [ ] **Configurar Cliente GraphQL e Fluxo de Autenticação** (2 a 3 dias)
...
*As categorias são essenciais para classificar as transações.*
...
*O núcleo da aplicação, envolvendo maior complexidade de UI e integração de dados.*
...
*Garantir que a experiência do usuário seja fluida e segura.*
